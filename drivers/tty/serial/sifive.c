...
#define SIFIVE_SERIAL_SETUP_PARITY_EN_MASK		\
			(0x1 << SIFIVE_SERIAL_SETUP_PARITY_EN_SHIFT)
#define SIFIVE_SERIAL_SETUP_PARITY_SEL_SHIFT		0x1
#define SIFIVE_SERIAL_SETUP_PARITY_SEL_MASK		\
			(0x1 << SIFIVE_SERIAL_SETUP_PARITY_SEL_SHIFT)
...
#define SIFIVE_SERIAL_SETUP_BIT_LENGTH_SHIFT		0x4
#define SIFIVE_SERIAL_SETUP_BIT_LENGTH_MASK		\
			(0x7 << SIFIVE_SERIAL_SETUP_BIT_LENGTH_SHIFT)
...
static int sifive_serial_probe(struct platform_device *pdev)
{
	...
	/* setup serial */
	__ssp_writel(((0 << SIFIVE_SERIAL_SETUP_PARITY_EN_SHIFT) &
		     SIFIVE_SERIAL_SETUP_PARITY_EN_MASK) |
		     ((0 << SIFIVE_SERIAL_SETUP_PARITY_SEL_SHIFT) &
		     SIFIVE_SERIAL_SETUP_PARITY_SEL_MASK) |
		     ((3 << SIFIVE_SERIAL_SETUP_BIT_LENGTH_SHIFT) &
		     SIFIVE_SERIAL_SETUP_BIT_LENGTH_MASK),
